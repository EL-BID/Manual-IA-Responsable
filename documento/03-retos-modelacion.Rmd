...
-	Sub y sobre muestreo alteran la proporción natural de positivos y negativos en los datos. Esto quiere decir que las probabilidades obtenidas están mal calibradas y tienen menos utilidad para la toma de decisiones.
...
mujeres y hombres sean afectados de manera distinta. 

Sin embargo, *paridad demográfica* puede ser un objetivo de los tomadores de decisiones, y eso debe tomarse en cuenta al momento de tomar la decisión asociada a la predicción, o incluso puede ser un requisito legal que debe cumplirse.
En este caso, técnicas como entrenamiento adversarial (ver por ejemplo [https://aif360.mybluemix.net/]) puede ser útil, así como ajuste de puntos de corte con el fin
de alcanzar paridad demográfica (proporcional o absoluta).
...
Finalmente, estas herramientas abiertas pueden ayudar en el trabajo de medición y mitigación de sesgo:

- Python: https://github.com/IBM/AIF360
- R: https://github.com/IBM/AIF360/tree/master/aif360/aif360-r