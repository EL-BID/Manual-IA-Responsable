...
### Reto: Ausencia o uso no apropiado de muestras de validación
...
```{r ciclo, fig.cap="Etapas de evaluación. Construcción propia.", echo=FALSE}
...
```{block2, type='rmdtip'}
**Medida: Métricas de evaluación engañosas**
...
![Sub y sobre ajuste](images/under_over_fit.png)
