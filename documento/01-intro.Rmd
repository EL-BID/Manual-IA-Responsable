...
- El manual se concentrará en los retos de los sistemas de toma/soporte de decisión que se dan durante las fases de "fuente de datos y su manejo", "desarrollo del modelo", "uso y evaluación" y "rendición de cuentas". 
...
La IA no sustituye a la política pública ya que por sí misma no soluciona el problema social, su función es asistir en la toma de decisión proveyendo información para segmentar, clasificar, asociar o predecir. 

1. **(Identificación del problema)** Se debe iniciar identificando correctamente el problema social en el que la política pública busca impactar, identificando sus posbiles causas y consecuencias. 
1. **(Formulación de intervención)**  Se formula la intervención o política que se está considerando aplicar a ciertas personas, unidades o procesos. Supondremos generalmente que se tiene evidencia del beneficio de esa política cuando se aplica a la población objetivo.
...
3. **(Sistema de toma/soporte de decisión)** Una vez definida la intervención y los criterios de su implementación si esta  depende del conocimiento de características desconocidas de las personas, unidades o procesos. Se utilizan entonces sistemas de soporte de decisión basados en métodos de ML para su correcta implementación.
...
Este manual se enfoca en el diseño del sistema de toma o soporte de decisión. Ejemplos de esto puede ser:

- Predicción y alerta temprana de deserción escolar  (unidad individuo)
...
En este documento, nos concentramos en la parte de **Sistema de toma/soporte de decisión**, y cómo deficiencias o lagunas en el proceso de validación puede producir resultados indeseables en la **toma de decisión**
```
...
1. **Fuente y manejo de datos**: que se refieren principalmente a deficiencias, sesgos y al proceso que genera los datos utilizados (Ntoutsi et al. 2020). Este es un punto de bloqueo para muchas aplicaciones.
