...
en la construcción y en los métodos particulares de los sistemas de aprendizaje automático existen una gran variedad de técnicas, conocimiento experto del tema y de modelación en general, y **en este documento** no pretendemos definir cómo deben ser esos procedimientos. En lugar de eso

`r colorize("podríamos dejar recomendaciones de bibliografía que se enfoque en esto?", "red")`
