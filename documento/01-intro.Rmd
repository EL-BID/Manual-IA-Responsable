...
En este manual se pretende discutir los problemas más comunes en el uso del aprendizaje automático (ML) como parte de un sistema de toma/soporte de decisión como detectar problemas potenciales y evaluar la posibilidad de resultados indeseables para la sociedad o una compañía o institución particular. 
...
Debe notarse que el primer esquema es el más apropiada para decisiones individuales de alto riesgo o beneficio.

Esta guía no pretende discutir métodos particulares de aprendizaje automático. En la construcción y en los métodos particulares de los sistemas de aprendizaje automático existen una gran variedad de técnicas, conocimiento experto del tema y de modelación en general que se deben de considerar para el desarrollo de un sistema de soporte/toma de decisión exitoso. **En este documento** no se describirán técnicas o modelos particulares  (ver por ejemplo @ESL, @kuhn, @GelmanHill). 

Por otra parte, la evaluación de un sistema de aprendizaje no tiene sentido fuera de su contexto, preguntas como: ¿qué es una tasa de error apropiado? o ¿cuáles son sesgos poco aceptables?, entre otras, sólo pueden considerarse dentro del contexto específico de su aplicación y de los propósitos y motivaciones de los tomadores de decisiones. Esto quiere decir que, aunque mucha de la discusión se concentra en aspectos técnicos, métricas particulares de desempeño o métodos de ML, al final ninguna de estas discusiones tiene sentido fuera del contexto de **la decisión** que se quiere tomar, ya sea una decisión automatizada totalmente o cuyo resultado se toma como insumo de una decisión tomada por páneles de expertos o tomadores de decisiones.
...
Existen tres componentes importantes para la creación de un sistema de soporte de decisión. 
1. **(Conceptualización y diseño)** Se define una intervención o política que se está considerando aplicar a ciertas personas, unidades o procesos. Supondremos generalmente que se tiene evidencia del beneficio de esa política cuando se aplica a la población objetivo.
2. **(Universal o focalización)** Se define si la intervención o política pretende aplicarse a toda la población o focalizarse a ciertas unidades o circunstancias para mejorar resultados u optimizar el uso de recursos limitados.
3. **(Predicción o Estimación)** En el caso que se defina una intervención focalizada y esta  depende del conocimiento de características desconocidas de las personas, unidades o procesos. Se utilizan entonces predicciones, estimaciones o segmentaciones basadas en métodos de ML para informar variables desconocidas y hacer una recomendación de focalización.
...
Este libro describe en cuatro secciones los problemas más comunes, diagnósticos para detectarlos, y sugerencias para mitigarlos:


1. **Fuente manejo de datos**: que se refieren principalmente a deficiencias, sesgos y al proceso que genera los datos utilizados (Ntoutsi et al. 2020). Este es un punto de bloqueo para muchas aplicaciones.
2. **Construcción y desarrollo de modelos**: que se refiere a métodos y principios importantes para construir modelos robustos y validados correctamente.
3. **Evaluación y monitoreo del modelo**: que se refiere a la interpretación del modelo, evaluación una vez puesto en producción y principios de monitoreo para evitar consecuencias inesperadas.
