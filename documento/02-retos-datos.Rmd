...
`r colorize("Mientras leía me parece que los retos entran demasiado rápido y falta algo de contexto. ¿Qué pensarías de empezar los capítulos no por el reto sino con el ciclo del proyecto?", "red")`

`r colorize("Bajo el comentario anterior creo que sería bueno empezar este capítulo describiendo los pros y contras de las posibles fuentes de info de un proyecto de Ciencia de datos en política pública y que eso te lleve a discutir su calidad y relevancia.", "red")`
...
Sin embargo, no siempre los datos recolectados tienen una frecuencia o desagregación que los haga relevantes o no tienen la calidad necesaria para ser utilizados. Por ejemplo, las encuestas diseñadas mediante muestreos probabilístico especifican el tipo de análisis que se pueden hacer con ellas pero suelen levantarse con poca frecuencia y son insuficientes para capturar el movimiento de los patrones a estudiar, la información proveniente de registros administrativos suele tener una frecuencia mucho mayor pero en pocos casos cubre a la población en su conjunto. `r colorize("Vi que esto lo mencionan más abajo pero creo que comentarlo brevemente aquí podría hacer más cercano/entendible.", "red")`
...
`r colorize("ToDo(R): discusion de diferencias con discriminacion pasada - ", "red")` [e.g.](https://science.sciencemag.org/content/366/6464/447.abstract)
...
dada. Decidimos tomar una muestra `r colorize("natural", "red")`  
acudiendo a hospitales que "corresponden" a la población 
...
para la población objetivo sea muy distinta de la que obtenemos con nuestra muestra natural.

`r colorize("*Nota - Sistema de auto diagnóstico: https://www.nature.com/articles/s41467-018-07262-2 pueden existir diferencias importantes en la presencia - > https://www.ncbi.nlm.nih.gov/pubmed/7282595", "red")`
