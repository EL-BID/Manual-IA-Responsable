...
El primer conjunto de retos que tratamos es el que tiene qué ver
con los datos disponibles para aplicar métodos de aprendizaje automático. 
Estos retos se pueden separar en dos grandes grupos:
...
*número de unidades que fueron requeridas en el sistema* para el medicamento X. Ésta no es una medida 
...
- Muestras *representativas* no son necesarias ni en construcción de modelos ni en validación. Por ejemplo, 
