...
Consideramos dos retos a enfrentar: en primer lugar, aprendizaje de métricas que son indeseables desde el 
punto de vista de los tomador de decisiones. Si las métricas que queremos predecir 
son resultado de sistemas subóptimos o con inequidades o deficiencias históricos, 
los algoritmos entrenados tenderán a aprender los mismos patrones indeseables.

El segundo reto es cuando utilizamos medidas *proxy* o sucedáneas por no tener disponibilidad de la medición
ideal para tomar decisiones. Medidas sistemáticamente sesgadas o sucedáneos pobres de las métricas 
ideales pueden producir algoritmos con consecuencias indeseables.
...
```{block2, type='rmdnote'}
**Reto: especificación incorrecta de métrica objetivo**
  
- Las métricas objetivo definidas son producidas por sistemas en estados indeseables desde el punto de vista de la política de interés.
- Los estados indeseables incluyen defectos y inequidades históricas capturados en la métrica objetivo, y generalmente es difícil tener información detallada acerca de esos defectos o inequidades.
...
- (Cualitativa) Debe establecerse claramente que la utilización de la métrica objetivo seleccionada
está alineada con los propósitos o políticas de los tomadores de decisiones. 

```


En el segundo reto, consideramos métricas sustitutos de las métricas objetivo ideales:
