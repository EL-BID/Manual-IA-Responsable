...
```{block2, type='rmdnote'}
  El desempeño de un modelo puede degradarse en el tiempo debido a cambios en la población sobre la que se hacen predicciones o por el cambio en la metodología de levantamiento o la calidad de los datos recolectados. 

```

Cantidades con tasa total de positivos y negativos (incluyendo desagregaciones por otras variables protegidas o de interés), distribución de predicciones y atributos o variables deben monitorearse en cada ronda de predicción.
