...
```{r ciclo, fig.cap="Etapas de evaluación. *Fuente:* Construcción propia", echo=FALSE, out.width="90%"}
...
```{r sub-sobre-ajuste, fig.cap="Sub y sobreajuste. *Fuente:* Preparado por los autores", echo=FALSE, out.width="90%"}
