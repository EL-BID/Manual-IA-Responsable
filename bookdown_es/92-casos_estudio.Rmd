...
knitr::include_graphics("images/plot-feature-importance.png")
```
...
Considérese el ejemplo  de  factores  para  detectar  una  enfermedad  del  corazón [@saheart]:
...
knitr::include_graphics("images/plot-shapely.png")
```
...
```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics("images/plot-shapely-2.png")
```
